...
<template>
  ...
  <div v-if="activeGrid=='grid_1'" :class="activeGrid=='grid_1'?'grid  lg:grid-cols-3 gap-4 w-[80%] m-auto mt-[100px]':''">
   ...
   <div v-else-if="activeGrid=='grid_2'" :class="activeGrid=='grid_2'?'grid lg:grid-cols-4 gap-4 w-[90%] m-auto mt-[100px]':''">
   ...
   <div v-else-if="activeGrid=='grid_3'" :class="activeGrid=='grid_3'?'grid grid-cols-1 mt-[100px] w-[90%] m-auto':''">
   ...
   <div class="md:w-2/3">
     ...
     <p class="text-gray-600 text-xl mb-4 mt-[50px]">
       {{ product.description }}
     </p>
     
     <button class="inline-block mt-[40px] bg-gray-700 hover:bg-white text-white hover:text-gray-800 border hover:border-gray-800 font-medium py-2 px-6  transition-colors duration-300"
