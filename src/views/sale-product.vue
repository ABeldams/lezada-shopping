...
<div class=" bg-gray-100 mt-[90px] p-10" :style="{ backgroundImage: `url(${bgImage})` }">
    <h1 class="sm:text-3xl md:text-6xl lg:text-6xl p-4  text-black">Sale Product</h1>
    ...
    <p class="text-xl p-4" :class="active?'text-black':'text-gray-400'">Sale Product</p>
    </div>
</div>
    ...
    <div class="flex flex-wrap">
      <div class="w-full">
        ...
        <div class="text-center">
          <h1 class="text-3xl md:text-4xl lg:text-5xl  mb-4">Sale products</h1>
          <p class="text-lg text-gray-600 max-w-2xl mx-auto">This is where to find your satisfactory products.</p>
        </div>
